...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Aleksandar.</span> I'm a{" "}
        <span className="font-bold">frontend developer</span> I enjoy building{" "}
        <span className="italic">sites & apps</span>. My focus is{" "}
        <span className="underline">JavaScript,TypeScript and React</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/aleksandar-drobnjak-0029471ab/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/AleksandarDrobnjak"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
